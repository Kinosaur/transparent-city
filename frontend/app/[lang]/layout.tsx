...
export default async function LocaleLayout({
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <a href="#main-content" className="sr-only fixed left-4 top-4 z-[60] rounded-lg bg-[--color-teal-400] px-4 py-2 text-sm font-medium text-slate-950 focus:not-sr-only">
        {dict.site.skip_to_content}
      </a>
